...
# Plot actual prices and regression lines
    ax.plot(x_values, upper_lr, color="blue", linestyle="--", linewidth=2,label="Upper Channel")
    ax.plot(x_values, lower_lr, color="blue", linestyle="--", linewidth=2,label="Lower Channel")
